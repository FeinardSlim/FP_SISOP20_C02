   ...
   7:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 5b 04 00 00       	call   480 <printf>
    exit();
  25:	e8 08 03 00 00       	call   332 <exit>
  }
  ...
  32:	e8 5b 03 00 00       	call   392 <link>
...
free(void *ap)
{
 ...
 651:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 fc 0a 00 00    	cmp    %eax,0xafc
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 7a7:	0b 00 00 
 7aa:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 7b1:	0b 00 00 
    base.s.size = 0;
 7b4:	b8 00 0b 00 00       	mov    $0xb00,%eax
 7b9:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 7c0:	00 00 00 
