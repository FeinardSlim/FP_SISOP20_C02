...
main(void)
{
  ...
  exit();
  16:	e8 07 04 00 00       	call   422 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
00000020 <printf>:
{
  ...
  38:	e8 05 04 00 00       	call   442 <write>
}
  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  59:	68 c4 04 00 00       	push   $0x4c4
  5e:	e8 6d 01 00 00       	call   1d0 <strlen>
  63:	83 c4 0c             	add    $0xc,%esp
  66:	50                   	push   %eax
  67:	68 c4 04 00 00       	push   $0x4c4
  6c:	6a 01                	push   $0x1
  6e:	e8 cf 03 00 00       	call   442 <write>
  ...
  8f:	74 4f                	je     e0 <forktest+0x90>
    pid = fork();
  91:	e8 84 03 00 00       	call   41a <fork>
    if(pid < 0)
  ...
  9e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  a0:	e8 85 03 00 00       	call   42a <wait>
  ...
  e3:	68 04 05 00 00       	push   $0x504
  e8:	e8 e3 00 00 00       	call   1d0 <strlen>
  ed:	83 c4 0c             	add    $0xc,%esp
  f0:	50                   	push   %eax
  f1:	68 04 05 00 00       	push   $0x504
  f6:	6a 01                	push   $0x1
  f8:	e8 45 03 00 00       	call   442 <write>
    exit();
  fd:	e8 20 03 00 00       	call   422 <exit>
      exit();
 102:	e8 1b 03 00 00       	call   422 <exit>
  write(fd, s, strlen(s));
 107:	83 ec 0c             	sub    $0xc,%esp
 10a:	68 cf 04 00 00       	push   $0x4cf
 10f:	e8 bc 00 00 00       	call   1d0 <strlen>
 114:	83 c4 0c             	add    $0xc,%esp
 117:	50                   	push   %eax
 118:	68 cf 04 00 00       	push   $0x4cf
 11d:	6a 01                	push   $0x1
 11f:	e8 1e 03 00 00       	call   442 <write>
      exit();
 124:	e8 f9 02 00 00       	call   422 <exit>
  write(fd, s, strlen(s));
 129:	83 ec 0c             	sub    $0xc,%esp
 12c:	68 e3 04 00 00       	push   $0x4e3
 131:	e8 9a 00 00 00       	call   1d0 <strlen>
 136:	83 c4 0c             	add    $0xc,%esp
 139:	50                   	push   %eax
 13a:	68 e3 04 00 00       	push   $0x4e3
 13f:	6a 01                	push   $0x1
 141:	e8 fc 02 00 00       	call   442 <write>
    exit();
 146:	e8 d7 02 00 00       	call   422 <exit>
 ...
 268:	89 f3                	mov    %esi,%ebx
{
 ...
 280:	50                   	push   %eax
 281:	6a 00                	push   $0x0
 283:	e8 b2 01 00 00       	call   43a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ed:	e8 70 01 00 00       	call   462 <open>
  if(fd < 0)
 ...
 301:	50                   	push   %eax
 302:	e8 73 01 00 00       	call   47a <fstat>
  close(fd);
 307:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 30a:	89 c6                	mov    %eax,%esi
  close(fd);
 30c:	e8 39 01 00 00       	call   44a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 3a7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 3aa:	80 38 00             	cmpb   $0x0,(%eax)
 3ad:	89 c2                	mov    %eax,%edx
 3af:	74 28                	je     3d9 <strcat+0x39>
 3b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 3b8:	83 c2 01             	add    $0x1,%edx
  while (*d)
 3bb:	80 3a 00             	cmpb   $0x0,(%edx)
 3be:	75 f8                	jne    3b8 <strcat+0x18>
  while (*s)
 3c0:	0f b6 0b             	movzbl (%ebx),%ecx
 3c3:	84 c9                	test   %cl,%cl
 3c5:	74 19                	je     3e0 <strcat+0x40>
 3c7:	89 f6                	mov    %esi,%esi
 3c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 3d0:	83 c2 01             	add    $0x1,%edx
 3d3:	83 c3 01             	add    $0x1,%ebx
 3d6:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 3d9:	0f b6 0b             	movzbl (%ebx),%ecx
 3dc:	84 c9                	test   %cl,%cl
 3de:	75 f0                	jne    3d0 <strcat+0x30>
  *d = 0;
 3e0:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 3e3:	5b                   	pop    %ebx
 3e4:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 400:	7e 14                	jle    416 <strncpy+0x26>
 ...
 414:	75 f2                	jne    408 <strncpy+0x18>
  }
  return os;
}
 416:	5b                   	pop    %ebx
