...
main(int argc, char *argv[])
{
  ...
  exit();
  5c:	e8 e1 02 00 00       	call   342 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
 ...
 188:	89 f3                	mov    %esi,%ebx
{
 ...
 1a0:	50                   	push   %eax
 1a1:	6a 00                	push   $0x0
 1a3:	e8 b2 01 00 00       	call   35a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 70 01 00 00       	call   382 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 73 01 00 00       	call   39a <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 39 01 00 00       	call   36a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 2c7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 2ca:	80 38 00             	cmpb   $0x0,(%eax)
 2cd:	89 c2                	mov    %eax,%edx
 2cf:	74 28                	je     2f9 <strcat+0x39>
 2d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 2d8:	83 c2 01             	add    $0x1,%edx
  while (*d)
 2db:	80 3a 00             	cmpb   $0x0,(%edx)
 2de:	75 f8                	jne    2d8 <strcat+0x18>
  while (*s)
 2e0:	0f b6 0b             	movzbl (%ebx),%ecx
 2e3:	84 c9                	test   %cl,%cl
 2e5:	74 19                	je     300 <strcat+0x40>
 2e7:	89 f6                	mov    %esi,%esi
 2e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 2f0:	83 c2 01             	add    $0x1,%edx
 2f3:	83 c3 01             	add    $0x1,%ebx
 2f6:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 2f9:	0f b6 0b             	movzbl (%ebx),%ecx
 2fc:	84 c9                	test   %cl,%cl
 2fe:	75 f0                	jne    2f0 <strcat+0x30>
  *d = 0;
 300:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 303:	5b                   	pop    %ebx
 304:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 320:	7e 14                	jle    336 <strncpy+0x26>
 ...
 334:	75 f2                	jne    328 <strncpy+0x18>
  }
  return os;
}
 336:	5b                   	pop    %ebx
