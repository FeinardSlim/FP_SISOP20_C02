...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 e4 02 00 00       	call   2fa <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 6e 03 00 00       	call   392 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 d6 02 00 00       	call   302 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 148:	89 f3                	mov    %esi,%ebx
{
 ...
 160:	50                   	push   %eax
 161:	6a 00                	push   $0x0
 163:	e8 b2 01 00 00       	call   31a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 70 01 00 00       	call   342 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 73 01 00 00       	call   35a <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 39 01 00 00       	call   32a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 287:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 28a:	80 38 00             	cmpb   $0x0,(%eax)
 28d:	89 c2                	mov    %eax,%edx
 28f:	74 28                	je     2b9 <strcat+0x39>
 291:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 298:	83 c2 01             	add    $0x1,%edx
  while (*d)
 29b:	80 3a 00             	cmpb   $0x0,(%edx)
 29e:	75 f8                	jne    298 <strcat+0x18>
  while (*s)
 2a0:	0f b6 0b             	movzbl (%ebx),%ecx
 2a3:	84 c9                	test   %cl,%cl
 2a5:	74 19                	je     2c0 <strcat+0x40>
 2a7:	89 f6                	mov    %esi,%esi
 2a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 2b0:	83 c2 01             	add    $0x1,%edx
 2b3:	83 c3 01             	add    $0x1,%ebx
 2b6:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 2b9:	0f b6 0b             	movzbl (%ebx),%ecx
 2bc:	84 c9                	test   %cl,%cl
 2be:	75 f0                	jne    2b0 <strcat+0x30>
  *d = 0;
 2c0:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 2c3:	5b                   	pop    %ebx
 2c4:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 2e0:	7e 14                	jle    2f6 <strncpy+0x26>
 ...
 2f4:	75 f2                	jne    2e8 <strncpy+0x18>
  }
  return os;
}
 2f6:	5b                   	pop    %ebx
...
free(void *ap)
{
 ...
 621:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 a0 0a 00 00    	cmp    %eax,0xaa0
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 a0 0a 00 00 a4 	movl   $0xaa4,0xaa0
 777:	0a 00 00 
 77a:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
 789:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 790:	00 00 00 
