...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      27:	e8 a6 0d 00 00       	call   dd2 <open>
...
fork1(void)
{
  ...
  pid = fork();
      41:	e8 44 0d 00 00       	call   d8a <fork>
  if(pid == -1)
    ...
    wait();
      4f:	e8 46 0d 00 00       	call   d9a <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  pid = fork();
      7c:	e8 09 0d 00 00       	call   d8a <fork>
  if(pid == -1)
    ...
    panic("fork");
      ...
      96:	50                   	push   %eax
      97:	e8 1e 0d 00 00       	call   dba <close>
      break;
      9c:	83 c4 10             	add    $0x10,%esp
      9f:	eb b3                	jmp    54 <main+0x54>
  exit();
      a1:	e8 ec 0c 00 00       	call   d92 <exit>
      runcmd(parsecmd(buf));
      ...
      if(chdir(buf+3) < 0)
      d6:	e8 27 0d 00 00       	call   e02 <chdir>
...
00000150 <panic>:
{
  ...
  exit();
     165:	e8 28 0c 00 00       	call   d92 <exit>
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     19c:	52                   	push   %edx
     19d:	50                   	push   %eax
     19e:	e8 27 0c 00 00       	call   dca <exec>
    ...
    exit();
     1b8:	e8 d5 0b 00 00       	call   d92 <exit>
  pid = fork();
     1bd:	e8 c8 0b 00 00       	call   d8a <fork>
  if(pid == -1)
    ...
    close(rcmd->fd);
     ...
     1e0:	e8 d5 0b 00 00       	call   dba <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     1e5:	59                   	pop    %ecx
     1e6:	58                   	pop    %eax
     1e7:	ff 73 10             	pushl  0x10(%ebx)
     1ea:	ff 73 08             	pushl  0x8(%ebx)
     1ed:	e8 e0 0b 00 00       	call   dd2 <open>
  ...
  pid = fork();
     237:	e8 4e 0b 00 00       	call   d8a <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     24b:	e8 6a 0b 00 00       	call   dba <close>
    close(p[1]);
     250:	58                   	pop    %eax
     251:	ff 75 f4             	pushl  -0xc(%ebp)
     254:	e8 61 0b 00 00       	call   dba <close>
    wait();
     259:	e8 3c 0b 00 00       	call   d9a <wait>
    wait();
     25e:	e8 37 0b 00 00       	call   d9a <wait>
    break;
     263:	83 c4 10             	add    $0x10,%esp
     266:	e9 4d ff ff ff       	jmp    1b8 <runcmd+0x48>
  pid = fork();
     26b:	e8 1a 0b 00 00       	call   d8a <fork>
  if(pid == -1)
    ...
    wait();
     27d:	e8 18 0b 00 00       	call   d9a <wait>
    runcmd(lcmd->right);
    ...
    panic("fork");
     ...
     2aa:	6a 00                	push   $0x0
     2ac:	e8 09 0b 00 00       	call   dba <close>
      dup(p[0]);
     2b1:	5a                   	pop    %edx
     2b2:	ff 75 f0             	pushl  -0x10(%ebp)
     2b5:	e8 50 0b 00 00       	call   e0a <dup>
      close(p[0]);
     2ba:	59                   	pop    %ecx
     2bb:	ff 75 f0             	pushl  -0x10(%ebp)
     2be:	e8 f7 0a 00 00       	call   dba <close>
      close(p[1]);
     2c3:	58                   	pop    %eax
     2c4:	ff 75 f4             	pushl  -0xc(%ebp)
     2c7:	e8 ee 0a 00 00       	call   dba <close>
      runcmd(pcmd->right);
     2cc:	58                   	pop    %eax
     ...
     2e5:	6a 01                	push   $0x1
     2e7:	e8 ce 0a 00 00       	call   dba <close>
      dup(p[1]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f4             	pushl  -0xc(%ebp)
     2f0:	e8 15 0b 00 00       	call   e0a <dup>
      close(p[0]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f0             	pushl  -0x10(%ebp)
     2f9:	e8 bc 0a 00 00       	call   dba <close>
      close(p[1]);
     2fe:	58                   	pop    %eax
     2ff:	ff 75 f4             	pushl  -0xc(%ebp)
     302:	e8 b3 0a 00 00       	call   dba <close>
      runcmd(pcmd->left);
     307:	58                   	pop    %eax
...
00000310 <fork1>:
{
  ...
  pid = fork();
     316:	e8 6f 0a 00 00       	call   d8a <fork>
  if(pid == -1)
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 38 19 00 00       	push   $0x1938
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 38 19 00 00       	push   $0x1938
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 30 19 00 00       	push   $0x1930
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 38 19 00 00       	push   $0x1938
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 38 19 00 00       	push   $0x1938
     ...
     bd8:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     bf0:	50                   	push   %eax
     bf1:	6a 00                	push   $0x0
     bf3:	e8 b2 01 00 00       	call   daa <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c5d:	e8 70 01 00 00       	call   dd2 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     c71:	50                   	push   %eax
     c72:	e8 73 01 00 00       	call   dea <fstat>
  close(fd);
     c77:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     c7a:	89 c6                	mov    %eax,%esi
  close(fd);
     c7c:	e8 39 01 00 00       	call   dba <close>
  return r;
...
strcat(char *d,const char *s)
{
     ...
     d17:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
     d1a:	80 38 00             	cmpb   $0x0,(%eax)
     d1d:	89 c2                	mov    %eax,%edx
     d1f:	74 28                	je     d49 <strcat+0x39>
     d21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
     d28:	83 c2 01             	add    $0x1,%edx
  while (*d)
     d2b:	80 3a 00             	cmpb   $0x0,(%edx)
     d2e:	75 f8                	jne    d28 <strcat+0x18>
  while (*s)
     d30:	0f b6 0b             	movzbl (%ebx),%ecx
     d33:	84 c9                	test   %cl,%cl
     d35:	74 19                	je     d50 <strcat+0x40>
     d37:	89 f6                	mov    %esi,%esi
     d39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
     d40:	83 c2 01             	add    $0x1,%edx
     d43:	83 c3 01             	add    $0x1,%ebx
     d46:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
     d49:	0f b6 0b             	movzbl (%ebx),%ecx
     d4c:	84 c9                	test   %cl,%cl
     d4e:	75 f0                	jne    d40 <strcat+0x30>
  *d = 0;
     d50:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
     d53:	5b                   	pop    %ebx
     d54:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
  ...
  for (i = 0; i < n; i++)
     ...
     d70:	7e 14                	jle    d86 <strncpy+0x26>
  ...
  for (i = 0; i < n; i++)
     ...
     d84:	75 f2                	jne    d78 <strncpy+0x18>
  }
  return os;
}
     d86:	5b                   	pop    %ebx
     ...
     e49:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
     ...
     eb0:	e8 fd fe ff ff       	call   db2 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     f20:	e8 8d fe ff ff       	call   db2 <write>
  ...
  write(fd, &c, 1);
     ...
     f81:	e8 2c fe ff ff       	call   db2 <write>
  ...
  write(fd, &c, 1);
     f9a:	e8 13 fe ff ff       	call   db2 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    1033:	57                   	push   %edi
    1034:	53                   	push   %ebx
    1035:	e8 78 fd ff ff       	call   db2 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1087:	e8 26 fd ff ff       	call   db2 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10b1:	a1 a4 19 00 00       	mov    0x19a4,%eax
{
  ...
  freep = p;
    10ef:	a3 a4 19 00 00       	mov    %eax,0x19a4
}
    10f4:	5b                   	pop    %ebx
    10f5:	5e                   	pop    %esi
    10f6:	5f                   	pop    %edi
    ...
    1106:	72 ce                	jb     10d6 <free+0x26>
{
  ...
  freep = p;
    112a:	a3 a4 19 00 00       	mov    %eax,0x19a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    114c:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    11bb:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
    ...
    11e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    11e7:	89 15 a4 19 00 00    	mov    %edx,0x19a4
}
    ...
    1207:	19 00 00 
    120a:	c7 05 a8 19 00 00 a8 	movl   $0x19a8,0x19a8
    1211:	19 00 00 
    base.s.size = 0;
    1214:	b8 a8 19 00 00       	mov    $0x19a8,%eax
    1219:	c7 05 ac 19 00 00 00 	movl   $0x0,0x19ac
    1220:	00 00 00 
