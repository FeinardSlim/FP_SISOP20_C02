...
for(int i=1;i<argc;++i){
  ...
  2e:	68 02 02 00 00       	push   $0x202
  33:	ff 73 fc             	pushl  -0x4(%ebx)
  36:	e8 27 03 00 00       	call   362 <open>
for(int i=1;i<argc;++i){
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	39 f3                	cmp    %esi,%ebx
  40:	75 e6                	jne    28 <main+0x28>
}

exit();
  42:	e8 db 02 00 00       	call   322 <exit>
  47:	66 90                	xchg   %ax,%ax
  49:	66 90                	xchg   %ax,%ax
  4b:	66 90                	xchg   %ax,%ax
  4d:	66 90                	xchg   %ax,%ax
 ...
 168:	89 f3                	mov    %esi,%ebx
{
 ...
 180:	50                   	push   %eax
 181:	6a 00                	push   $0x0
 183:	e8 b2 01 00 00       	call   33a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ed:	e8 70 01 00 00       	call   362 <open>
  if(fd < 0)
 ...
 201:	50                   	push   %eax
 202:	e8 73 01 00 00       	call   37a <fstat>
  close(fd);
 207:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 20a:	89 c6                	mov    %eax,%esi
  close(fd);
 20c:	e8 39 01 00 00       	call   34a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 2a7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 2aa:	80 38 00             	cmpb   $0x0,(%eax)
 2ad:	89 c2                	mov    %eax,%edx
 2af:	74 28                	je     2d9 <strcat+0x39>
 2b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 2b8:	83 c2 01             	add    $0x1,%edx
  while (*d)
 2bb:	80 3a 00             	cmpb   $0x0,(%edx)
 2be:	75 f8                	jne    2b8 <strcat+0x18>
  while (*s)
 2c0:	0f b6 0b             	movzbl (%ebx),%ecx
 2c3:	84 c9                	test   %cl,%cl
 2c5:	74 19                	je     2e0 <strcat+0x40>
 2c7:	89 f6                	mov    %esi,%esi
 2c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 2d0:	83 c2 01             	add    $0x1,%edx
 2d3:	83 c3 01             	add    $0x1,%ebx
 2d6:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 2d9:	0f b6 0b             	movzbl (%ebx),%ecx
 2dc:	84 c9                	test   %cl,%cl
 2de:	75 f0                	jne    2d0 <strcat+0x30>
  *d = 0;
 2e0:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 2e3:	5b                   	pop    %ebx
 2e4:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 300:	7e 14                	jle    316 <strncpy+0x26>
 ...
 314:	75 f2                	jne    308 <strncpy+0x18>
  }
  return os;
}
 316:	5b                   	pop    %ebx
 ...
 641:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 c8 0a 00 00       	mov    %eax,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 789:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 797:	0a 00 00 
 79a:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 7a1:	0a 00 00 
    base.s.size = 0;
 7a4:	b8 cc 0a 00 00       	mov    $0xacc,%eax
 7a9:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 7b0:	00 00 00 
