...
main(int argc, char **argv)
{
  ...
  38:	e8 25 03 00 00       	call   362 <kill>
  for(i=1; i<argc; i++)
  3d:	83 c4 10             	add    $0x10,%esp
  40:	39 f3                	cmp    %esi,%ebx
  42:	75 e4                	jne    28 <main+0x28>
  exit();
  44:	e8 e9 02 00 00       	call   332 <exit>
    printf(2, "usage: kill pid...\n");
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
  ...
  52:	e8 29 04 00 00       	call   480 <printf>
    exit();
  57:	e8 d6 02 00 00       	call   332 <exit>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
 ...
 3e9:	85 d2                	test   %edx,%edx
{
 ...
 417:	f7 f1                	div    %ecx
 419:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb ec 07 00 00       	mov    $0x7ec,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 ec 0a 00 00    	cmp    %eax,0xaec
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 7a7:	0a 00 00 
 7aa:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
