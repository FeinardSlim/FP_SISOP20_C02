...
main(int argc, char *argv[])
{
  ...
  exit();
  3c:	e8 c1 05 00 00       	call   602 <exit>
    ls(".");
  41:	83 ec 0c             	sub    $0xc,%esp
  44:	68 f0 0a 00 00       	push   $0xaf0
  49:	e8 b2 00 00 00       	call   100 <ls>
    exit();
  4e:	e8 af 05 00 00       	call   602 <exit>
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 2b 05 00 00       	call   642 <open>
 ...
 129:	56                   	push   %esi
 12a:	50                   	push   %eax
 12b:	e8 2a 05 00 00       	call   65a <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 cf 04 00 00       	call   62a <close>
 ...
 213:	e8 12 04 00 00       	call   62a <close>
    return;
 ...
 26b:	50                   	push   %eax
 26c:	53                   	push   %ebx
 26d:	e8 a8 03 00 00       	call   61a <read>
...
free(void *ap)
{
 ...
 921:	a1 78 0e 00 00       	mov    0xe78,%eax
{
 ...
 95d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 95f:	a3 78 0e 00 00       	mov    %eax,0xe78
}
 964:	5b                   	pop    %ebx
 965:	5e                   	pop    %esi
 966:	5f                   	pop    %edi
 ...
 976:	72 ce                	jb     946 <free+0x26>
{
 ...
 997:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 99a:	a3 78 0e 00 00       	mov    %eax,0xe78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9bc:	8b 15 78 0e 00 00    	mov    0xe78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ff:	73 47                	jae    a48 <malloc+0x98>
    ...
    if(p == freep)
 a01:	39 05 78 0e 00 00    	cmp    %eax,0xe78
 ...
 a26:	e8 f5 fe ff ff       	call   920 <free>
  return freep;
 a2b:	8b 15 78 0e 00 00    	mov    0xe78,%edx
 ...
 a54:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a57:	89 15 78 0e 00 00    	mov    %edx,0xe78
}
 ...
 a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 78 0e 00 00 7c 	movl   $0xe7c,0xe78
 a77:	0e 00 00 
 a7a:	c7 05 7c 0e 00 00 7c 	movl   $0xe7c,0xe7c
 a81:	0e 00 00 
    base.s.size = 0;
 a84:	b8 7c 0e 00 00       	mov    $0xe7c,%eax
 a89:	c7 05 80 0e 00 00 00 	movl   $0x0,0xe80
 a90:	00 00 00 
