...
main(void)
{
  ...
  19:	e8 e4 03 00 00       	call   402 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 07 04 00 00       	call   43a <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 fb 03 00 00       	call   43a <dup>
  ...
  52:	e8 b9 04 00 00       	call   510 <printf>
    pid = fork();
  57:	e8 5e 03 00 00       	call   3ba <fork>
    if(pid < 0){
  ...
  70:	e8 55 03 00 00       	call   3ca <wait>
  ...
  9a:	e8 71 04 00 00       	call   510 <printf>
      exit();
  9f:	e8 1e 03 00 00       	call   3c2 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 b4 0b 00 00       	push   $0xbb4
  ab:	68 96 08 00 00       	push   $0x896
  b0:	e8 45 03 00 00       	call   3fa <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 4d 04 00 00       	call   510 <printf>
      exit();
  c3:	e8 fa 02 00 00       	call   3c2 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 68 08 00 00       	push   $0x868
  d2:	e8 33 03 00 00       	call   40a <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 68 08 00 00       	push   $0x868
  e0:	e8 1d 03 00 00       	call   402 <open>
 ...
 208:	89 f3                	mov    %esi,%ebx
{
 ...
 220:	50                   	push   %eax
 221:	6a 00                	push   $0x0
 223:	e8 b2 01 00 00       	call   3da <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 70 01 00 00       	call   402 <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 73 01 00 00       	call   41a <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 39 01 00 00       	call   3ea <close>
  return r;
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 3a0:	7e 14                	jle    3b6 <strncpy+0x26>
 ...
 3b4:	75 f2                	jne    3a8 <strncpy+0x18>
  }
  return os;
}
 3b6:	5b                   	pop    %ebx
 ...
 6e1:	a1 bc 0b 00 00       	mov    0xbbc,%eax
{
 ...
 71d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 71f:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
 724:	5b                   	pop    %ebx
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
 ...
 736:	72 ce                	jb     706 <free+0x26>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 bc 0b 00 00       	mov    %eax,0xbbc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 bc 0b 00 00    	mov    0xbbc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 47                	jae    808 <malloc+0x98>
    ...
    if(p == freep)
 7c1:	39 05 bc 0b 00 00    	cmp    %eax,0xbbc
 ...
 7e6:	e8 f5 fe ff ff       	call   6e0 <free>
  return freep;
 7eb:	8b 15 bc 0b 00 00    	mov    0xbbc,%edx
 ...
 814:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 817:	89 15 bc 0b 00 00    	mov    %edx,0xbbc
}
 ...
 837:	0b 00 00 
 83a:	c7 05 c0 0b 00 00 c0 	movl   $0xbc0,0xbc0
 841:	0b 00 00 
    base.s.size = 0;
 844:	b8 c0 0b 00 00       	mov    $0xbc0,%eax
 849:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 850:	00 00 00 
