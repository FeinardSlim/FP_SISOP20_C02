...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 68 03 00 00       	call   3a2 <unlink>
  ...
  exit();
  4b:	e8 02 03 00 00       	call   352 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 2e 04 00 00       	call   4a0 <printf>
    exit();
  72:	e8 db 02 00 00       	call   352 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 198:	89 f3                	mov    %esi,%ebx
{
 ...
 1b0:	50                   	push   %eax
 1b1:	6a 00                	push   $0x0
 1b3:	e8 b2 01 00 00       	call   36a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 70 01 00 00       	call   392 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 73 01 00 00       	call   3aa <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 39 01 00 00       	call   37a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 2d7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 2da:	80 38 00             	cmpb   $0x0,(%eax)
 2dd:	89 c2                	mov    %eax,%edx
 2df:	74 28                	je     309 <strcat+0x39>
 2e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 2e8:	83 c2 01             	add    $0x1,%edx
  while (*d)
 2eb:	80 3a 00             	cmpb   $0x0,(%edx)
 2ee:	75 f8                	jne    2e8 <strcat+0x18>
  while (*s)
 2f0:	0f b6 0b             	movzbl (%ebx),%ecx
 2f3:	84 c9                	test   %cl,%cl
 2f5:	74 19                	je     310 <strcat+0x40>
 2f7:	89 f6                	mov    %esi,%esi
 2f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 300:	83 c2 01             	add    $0x1,%edx
 303:	83 c3 01             	add    $0x1,%ebx
 306:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 309:	0f b6 0b             	movzbl (%ebx),%ecx
 30c:	84 c9                	test   %cl,%cl
 30e:	75 f0                	jne    300 <strcat+0x30>
  *d = 0;
 310:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 313:	5b                   	pop    %ebx
 314:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 330:	7e 14                	jle    346 <strncpy+0x26>
 ...
 344:	75 f2                	jne    338 <strncpy+0x18>
  }
  return os;
}
 346:	5b                   	pop    %ebx
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 2c 08 00 00 	movzbl 0x82c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 25 08 00 00       	mov    $0x825,%ebx
        while(*s != 0){
 ...
 671:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 28 0b 00 00       	mov    %eax,0xb28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 28 0b 00 00    	mov    0xb28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 28 0b 00 00    	cmp    %eax,0xb28
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 7c7:	0b 00 00 
 7ca:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 7d1:	0b 00 00 
    base.s.size = 0;
 7d4:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
