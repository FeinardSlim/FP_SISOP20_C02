  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  57:	e8 ae 03 00 00       	call   40a <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 79 03 00 00       	call   3e2 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 b8 04 00 00       	call   530 <printf>
      exit();
  78:	e8 65 03 00 00       	call   3e2 <exit>
    cat(0);
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 52 03 00 00       	call   402 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 30 03 00 00       	call   3fa <read>
  ...
  e7:	e8 44 04 00 00       	call   530 <printf>
      exit();
  ec:	e8 f1 02 00 00       	call   3e2 <exit>
  ...
  fa:	e8 31 04 00 00       	call   530 <printf>
    exit();
  ff:	e8 de 02 00 00       	call   3e2 <exit>
 ...
 228:	89 f3                	mov    %esi,%ebx
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 b2 01 00 00       	call   3fa <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 70 01 00 00       	call   422 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 73 01 00 00       	call   43a <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 39 01 00 00       	call   40a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 367:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 36a:	80 38 00             	cmpb   $0x0,(%eax)
 36d:	89 c2                	mov    %eax,%edx
 36f:	74 28                	je     399 <strcat+0x39>
 371:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 378:	83 c2 01             	add    $0x1,%edx
  while (*d)
 37b:	80 3a 00             	cmpb   $0x0,(%edx)
 37e:	75 f8                	jne    378 <strcat+0x18>
  while (*s)
 380:	0f b6 0b             	movzbl (%ebx),%ecx
 383:	84 c9                	test   %cl,%cl
 385:	74 19                	je     3a0 <strcat+0x40>
 387:	89 f6                	mov    %esi,%esi
 389:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 390:	83 c2 01             	add    $0x1,%edx
 393:	83 c3 01             	add    $0x1,%ebx
 396:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 399:	0f b6 0b             	movzbl (%ebx),%ecx
 39c:	84 c9                	test   %cl,%cl
 39e:	75 f0                	jne    390 <strcat+0x30>
  *d = 0;
 3a0:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 3a3:	5b                   	pop    %ebx
 3a4:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 3c0:	7e 14                	jle    3d6 <strncpy+0x26>
 ...
 3d4:	75 f2                	jne    3c8 <strncpy+0x18>
  }
  return os;
}
 3d6:	5b                   	pop    %ebx
...
free(void *ap)
{
 ...
 701:	a1 00 0c 00 00       	mov    0xc00,%eax
{
 ...
 73d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 73f:	a3 00 0c 00 00       	mov    %eax,0xc00
}
 744:	5b                   	pop    %ebx
 745:	5e                   	pop    %esi
 746:	5f                   	pop    %edi
 ...
 756:	72 ce                	jb     726 <free+0x26>
{
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 00 0c 00 00       	mov    %eax,0xc00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 15 00 0c 00 00    	mov    0xc00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 47                	jae    828 <malloc+0x98>
    ...
    if(p == freep)
 7e1:	39 05 00 0c 00 00    	cmp    %eax,0xc00
 ...
 806:	e8 f5 fe ff ff       	call   700 <free>
  return freep;
 80b:	8b 15 00 0c 00 00    	mov    0xc00,%edx
 ...
 834:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 837:	89 15 00 0c 00 00    	mov    %edx,0xc00
}
 ...
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 00 0c 00 00 04 	movl   $0xc04,0xc00
 857:	0c 00 00 
 85a:	c7 05 04 0c 00 00 04 	movl   $0xc04,0xc04
 861:	0c 00 00 
    base.s.size = 0;
 864:	b8 04 0c 00 00       	mov    $0xc04,%eax
 869:	c7 05 08 0c 00 00 00 	movl   $0x0,0xc08
 870:	00 00 00 
