...
main(int argc, char *argv[])
{
  ...
  3b:	6a 00                	push   $0x0
  3d:	ff 33                	pushl  (%ebx)
  3f:	e8 fe 05 00 00       	call   642 <open>
  ...
  66:	e8 bf 05 00 00       	call   62a <close>
  for(i = 2; i < argc; i++){
  ...
  exit();
  72:	e8 8b 05 00 00       	call   602 <exit>
    grep(pattern, 0);
  77:	52                   	push   %edx
  78:	52                   	push   %edx
  79:	6a 00                	push   $0x0
  ...
  7c:	e8 af 01 00 00       	call   230 <grep>
    exit();
  81:	e8 7c 05 00 00       	call   602 <exit>
      printf(1, "grep: cannot open %s\n", argv[i]);
  86:	50                   	push   %eax
  87:	ff 33                	pushl  (%ebx)
  89:	68 c8 0a 00 00       	push   $0xac8
  8e:	6a 01                	push   $0x1
  90:	e8 bb 06 00 00       	call   750 <printf>
      exit();
  95:	e8 68 05 00 00       	call   602 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  9a:	51                   	push   %ecx
  9b:	51                   	push   %ecx
  9c:	68 a8 0a 00 00       	push   $0xaa8
  a1:	6a 02                	push   $0x2
  a3:	e8 a8 06 00 00       	call   750 <printf>
    exit();
  a8:	e8 55 05 00 00       	call   602 <exit>
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 255:	e8 c0 03 00 00       	call   61a <read>
 ...
 2c4:	89 fb                	mov    %edi,%ebx
        write(1, p, q+1 - p);
 2c6:	6a 01                	push   $0x1
 2c8:	e8 55 03 00 00       	call   622 <write>
 ...
 448:	89 f3                	mov    %esi,%ebx
{
 ...
 460:	50                   	push   %eax
 461:	6a 00                	push   $0x0
 463:	e8 b2 01 00 00       	call   61a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4cd:	e8 70 01 00 00       	call   642 <open>
  if(fd < 0)
 ...
 4e1:	50                   	push   %eax
 4e2:	e8 73 01 00 00       	call   65a <fstat>
  close(fd);
 4e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4ea:	89 c6                	mov    %eax,%esi
  close(fd);
 4ec:	e8 39 01 00 00       	call   62a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 587:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 58a:	80 38 00             	cmpb   $0x0,(%eax)
 58d:	89 c2                	mov    %eax,%edx
 58f:	74 28                	je     5b9 <strcat+0x39>
 591:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 598:	83 c2 01             	add    $0x1,%edx
  while (*d)
 59b:	80 3a 00             	cmpb   $0x0,(%edx)
 59e:	75 f8                	jne    598 <strcat+0x18>
  while (*s)
 5a0:	0f b6 0b             	movzbl (%ebx),%ecx
 5a3:	84 c9                	test   %cl,%cl
 5a5:	74 19                	je     5c0 <strcat+0x40>
 5a7:	89 f6                	mov    %esi,%esi
 5a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 5b0:	83 c2 01             	add    $0x1,%edx
 5b3:	83 c3 01             	add    $0x1,%ebx
 5b6:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 5b9:	0f b6 0b             	movzbl (%ebx),%ecx
 5bc:	84 c9                	test   %cl,%cl
 5be:	75 f0                	jne    5b0 <strcat+0x30>
  *d = 0;
 5c0:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 5c3:	5b                   	pop    %ebx
 5c4:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 5e0:	7e 14                	jle    5f6 <strncpy+0x26>
 ...
 5f4:	75 f2                	jne    5e8 <strncpy+0x18>
  }
  return os;
}
 5f6:	5b                   	pop    %ebx
 ...
 6b9:	85 d2                	test   %edx,%edx
{
 ...
 6e7:	f7 f1                	div    %ecx
 6e9:	0f b6 92 e8 0a 00 00 	movzbl 0xae8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 904:	e9 8f fe ff ff       	jmp    798 <printf+0x48>
          s = "(null)";
 909:	bb de 0a 00 00       	mov    $0xade,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 921:	a1 e0 0e 00 00       	mov    0xee0,%eax
{
 ...
 95d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 95f:	a3 e0 0e 00 00       	mov    %eax,0xee0
}
 964:	5b                   	pop    %ebx
 965:	5e                   	pop    %esi
 966:	5f                   	pop    %edi
 ...
 976:	72 ce                	jb     946 <free+0x26>
{
 ...
 997:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 99a:	a3 e0 0e 00 00       	mov    %eax,0xee0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9bc:	8b 15 e0 0e 00 00    	mov    0xee0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a54:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a57:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 ...
 a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 e0 0e 00 00 e4 	movl   $0xee4,0xee0
 a77:	0e 00 00 
 a7a:	c7 05 e4 0e 00 00 e4 	movl   $0xee4,0xee4
 a81:	0e 00 00 
    base.s.size = 0;
 a84:	b8 e4 0e 00 00       	mov    $0xee4,%eax
 a89:	c7 05 e8 0e 00 00 00 	movl   $0x0,0xee8
 a90:	00 00 00 
