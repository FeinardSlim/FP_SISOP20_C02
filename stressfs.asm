  ...
  1c:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 a7 03 00 00       	call   40a <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 aa 03 00 00       	call   452 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 73 03 00 00       	call   432 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 6a 03 00 00       	call   43a <close>
  ...
  ee:	e8 5f 03 00 00       	call   452 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 1b 03 00 00       	call   42a <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 1a 03 00 00       	call   43a <close>

  wait();
 120:	e8 f5 02 00 00       	call   41a <wait>

  exit();
 125:	e8 e8 02 00 00       	call   412 <exit>
 ...
 258:	89 f3                	mov    %esi,%ebx
{
 ...
 270:	50                   	push   %eax
 271:	6a 00                	push   $0x0
 273:	e8 b2 01 00 00       	call   42a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 70 01 00 00       	call   452 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 73 01 00 00       	call   46a <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 39 01 00 00       	call   43a <close>
  return r;
...
strcat(char *d,const char *s)
{
 ...
 397:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *temp = d;
  while (*d)
 39a:	80 38 00             	cmpb   $0x0,(%eax)
 39d:	89 c2                	mov    %eax,%edx
 39f:	74 28                	je     3c9 <strcat+0x39>
 3a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ++d;
 3a8:	83 c2 01             	add    $0x1,%edx
  while (*d)
 3ab:	80 3a 00             	cmpb   $0x0,(%edx)
 3ae:	75 f8                	jne    3a8 <strcat+0x18>
  while (*s)
 3b0:	0f b6 0b             	movzbl (%ebx),%ecx
 3b3:	84 c9                	test   %cl,%cl
 3b5:	74 19                	je     3d0 <strcat+0x40>
 3b7:	89 f6                	mov    %esi,%esi
 3b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *d++ = *s++;
 3c0:	83 c2 01             	add    $0x1,%edx
 3c3:	83 c3 01             	add    $0x1,%ebx
 3c6:	88 4a ff             	mov    %cl,-0x1(%edx)
  while (*s)
 3c9:	0f b6 0b             	movzbl (%ebx),%ecx
 3cc:	84 c9                	test   %cl,%cl
 3ce:	75 f0                	jne    3c0 <strcat+0x30>
  *d = 0;
 3d0:	c6 02 00             	movb   $0x0,(%edx)
  return temp;
}
 3d3:	5b                   	pop    %ebx
 3d4:	5d                   	pop    %ebp
...
char *strncpy(char *s, const char *t, int n)
{
 ...
 3f0:	7e 14                	jle    406 <strncpy+0x26>
 ...
 404:	75 f2                	jne    3f8 <strncpy+0x18>
  }
  return os;
}
 406:	5b                   	pop    %ebx
